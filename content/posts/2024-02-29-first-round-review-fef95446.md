---
title: Why Yammer Believes the Traditional Engineering Organizational Structure is
  Dead
title_original: Why Yammer Believes the Traditional Engineering Organizational Structure
  is Dead
date: '2024-02-29'
source: First Round Review
source_url: https://review.firstround.com/why-yammer-believes-the-traditional-engineering-organizational-structure-is-dead/
author: ''
summary: '[翻译失败，原文如下]


  Kris Gale, VP of Engineering atYammer, argues the key to building fast at scale
  lies in small teams. He explores intricacies of organizat...'
categories:
- 未分类
tags: []
draft: false
translated_at: '2026-09-18T07:14:08.546674'
---

[翻译失败，原文如下]

Kris Gale, VP of Engineering atYammer, argues the key to building fast at scale lies in small teams. He explores intricacies of organizational design in engineering and explains how making intentional decisions throughout growth ensures that you don’t lose the things that are unique and special about being a startup. At the end of the day, it’s your job as a CTO to think about how engineering can be organized and optimized.
...
> 本文由AI自动翻译，原文链接：[Why Yammer Believes the Traditional Engineering Organizational Structure is Dead](https://review.firstround.com/why-yammer-believes-the-traditional-engineering-organizational-structure-is-dead/)
> 
